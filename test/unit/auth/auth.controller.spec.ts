...
describe('AuthController', () => {
  ...
  describe('refreshToken', () => {
    ...
    it('deve encapsular erro inesperado em BadRequestException genérica', () => {
      ...
      expect(() => controller.refreshToken('someToken')).toThrow(BadRequestException);
    });
  ...
  describe('logout', () => {
    ...
    it('deve encapsular erro inesperado em BadRequestException genérica', () => {
      ...
      expect(() => controller.logout('someToken')).toThrow(BadRequestException);
    });
  ...
  describe('validateToken', () => {
    ...
    it('deve lançar UnauthorizedException se token for inválido ou expirado', () => {
      ...
      expect(() => controller.validateToken('token-invalido')).toThrow(UnauthorizedException);
    });
    ...
    it('deve encapsular erro inesperado em BadRequestException genérica', () => {
      ...
      expect(() => controller.validateToken('someToken')).toThrow(BadRequestException);
    });
  });
});
