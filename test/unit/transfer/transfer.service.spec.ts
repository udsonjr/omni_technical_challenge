...
describe('TransferService', () => {
  ...
  describe('transfer', () => {
    ...
    it('deve lançar UnauthorizedException se o token for inválido', () => {
      ...
      expect(() => service.transfer('token-invalido', { toId: 'uuid-2', amount: 100 })).toThrow(
    ...
    it('deve lançar UnauthorizedException se o usuário de destino não for encontrado', () => {
      ...
      expect(() => service.transfer('token-1', { toId: 'uuid-inexistente', amount: 100 })).toThrow(
        UnauthorizedException,
      );
    });
    ...
    it('deve lançar BadRequestException se fromUser e toUser forem o mesmo usuário', () => {
      ...
      expect(() => service.transfer('token-1', { toId: 'uuid-1', amount: 100 })).toThrow(
        BadRequestException,
      );
    });
